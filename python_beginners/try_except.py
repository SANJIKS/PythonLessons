...
# ошибка - проблема в написании/синтаксисе кода
...
# b = 20
# print(c)
NameError # Исключение отсутствии имени
...
# num = 10
# num += 'string'
TypeError # ошибка типов данных, когда тип объекта не подходит под операции
...
ValueError # ошибка значения. Когда тип объекта подходит под условия, но его значение - нет
